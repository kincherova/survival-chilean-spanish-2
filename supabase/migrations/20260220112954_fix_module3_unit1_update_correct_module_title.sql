/*
  # Fix Module 3, Unit 1 "If you get lost…" lesson content update

  Previous migration used wrong module title ("🚕 Taxi/Uber Chat" instead of "🗺️ Moving around the city").
  This migration applies the correct updates using the actual module title.
  ...
  2. Multiple choice:
     ...
     - Update correct answer option text accordingly

  3. Dialogue page — add English translations to:
...
WHERE unit_id = (
  ...
  WHERE m.title = '🗺️ Moving around the city'
